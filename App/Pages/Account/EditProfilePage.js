...
import { ImageLoader, OverlayLoader } from '../../Components/Loader';
    ...
    return (
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <KeyboardAwareScrollView
          ...
          <View style={[styles.headerContent, {backgroundColor: '#ecf0f1', paddingBottom: 20, paddingTop: 20, marginTop: 60}]}>
          ...
          {/*  {
              Platform.OS === 'android' ?
                  null :
                  <Separator containerStyle={{backgroundColor: '#ecf0f1', paddingTop: 15, padding: 10}} label='Términos y Condiciones'/>
            }

            <LinkField label='Leer términos y condiciones'
                       underlayColor={"white"}
                       onPress={ () => {this.props.navigator.push({component: TermsAndConditions})} }
                       iconRight={
                          <Icon name='ios-arrow-forward'
                                size={30}
                                style={{alignSelf: null, marginRight: 0}} />
                        }
              />
              <SwitchField label='Acepto los término y con.' ref="has_accepted_conditions"/>*/}
          </Form>
        </KeyboardAwareScrollView>
        <Header
            title="Editar Perfil"
